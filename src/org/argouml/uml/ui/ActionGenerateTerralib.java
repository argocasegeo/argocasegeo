...
import org.argouml.terralib.*;
import java.util.*;


public class ActionGenerateTerralib extends ActionSaveXMI {
    ...
    public static ActionGenerateTerralib SINGLETON = new ActionGenerateTerralib();
    ...
    protected ActionGenerateTerralib() {
	super("Generate Terralib Model...", NO_ICON);
    }
